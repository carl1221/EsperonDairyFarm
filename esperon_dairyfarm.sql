-- ============================================================
-- Esperon Dairy Farm Database
-- Based on 3rd Normal Form (3NF) from Esperon_dairyFarm.xlsx
...
CREATE TABLE IF NOT EXISTS Orders (
    ...
    CONSTRAINT fk_ord_cust   FOREIGN KEY (CID)
        REFERENCES Customer (CID)
        ON UPDATE CASCADE
        ON DELETE RESTRICT,
    CONSTRAINT fk_ord_cow    FOREIGN KEY (Cow_ID)
        REFERENCES Cow (Cow_ID)
        ON UPDATE CASCADE
        ON DELETE RESTRICT,
    CONSTRAINT fk_ord_worker FOREIGN KEY (Worker_ID)
...
INSERT INTO Worker (Worker_ID, Worker, Worker_Role, Email, Password) VALUES
    (201, 'Mark', 'Staff', NULL, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi'),
    (202, 'Carl', 'Admin', NULL, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');
...
-- Full join used by the Orders API endpoint
-- ============================================================
